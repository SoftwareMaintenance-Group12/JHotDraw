...
public class AttributeKeys {
     ...
     */
    public static final AttributeKey<Double> CANVAS_FILL_OPACITY = new AttributeKey<>("canvasFillOpacity", Double.class, 1d, false, LABELS);
    /**
     ...
     */
    public static final AttributeKey<Double> STROKE_WIDTH = new AttributeKey<>("strokeWidth", Double.class, 1d, false, LABELS);
    /**
     ...
     */
    public static final AttributeKey<Double> STROKE_INNER_WIDTH_FACTOR = new AttributeKey<>("innerStrokeWidthFactor", Double.class, 2d, false, LABELS);
    /**
     * Stroke join. One of the BasicStroke.JOIN_... values used to construct a BasicStroke.
     */
    public static final AttributeKey<Integer> STROKE_JOIN = new AttributeKey<>("strokeJoin", Integer.class, BasicStroke.JOIN_MITER, false, LABELS);
    /**
     * Stroke join. One of the BasicStroke.CAP_... values used to construct a BasicStroke.
     */
    public static final AttributeKey<Integer> STROKE_CAP = new AttributeKey<>("strokeCap", Integer.class, BasicStroke.CAP_BUTT, false, LABELS);
    /**
     * Stroke miter limit factor. A double multiplied by total stroke width, used to construct the
     * miter limit of a BasicStroke.
     */
    public static final AttributeKey<Double> STROKE_MITER_LIMIT = new AttributeKey<>("strokeMiterLimitFactor", Double.class, 3d, false, LABELS);
    /**
     ...
     */
    public static final AttributeKey<Double> STROKE_DASH_PHASE = new AttributeKey<>("strokeDashPhase", Double.class, 0d, false, LABELS);
    /**
     ...
     */
    public static final AttributeKey<Boolean> IS_STROKE_PIXEL_VALUE = new AttributeKey<>("isStrokePixelValue", Boolean.class, false, false, LABELS);
     ...
     */
    public static final AttributeKey<Dimension2DDouble> TEXT_SHADOW_OFFSET = new AttributeKey<>("textShadowOffset", Dimension2DDouble.class, new Dimension2DDouble(1d, 1d), false, LABELS);
     ...
     * for the text.
     */
    public static final AttributeKey<Font> FONT_FACE = new AttributeKey<>("fontFace", Font.class, new Font("VERDANA", Font.PLAIN, 10), false, LABELS);
    /**
     * The value of this attribute is a double object.
     */
    public static final AttributeKey<Double> FONT_SIZE = new AttributeKey<>("fontSize", Double.class, 12d, false, LABELS);
    /**
    ...
    public static double getGlobalValueFactor(Figure f, double factor) {
        if (factor != 1.0 && Boolean.TRUE.equals(f.get(IS_STROKE_PIXEL_VALUE))) {
    ...
    public static double getStrokeTotalMiterLimit(Figure f, double factor) {
        if (Boolean.TRUE.equals(f.get(IS_STROKE_MITER_LIMIT_FACTOR))) {
    ...
    public static Stroke getStroke(Figure f, double factor) {
        ...
        double dashFactor = Boolean.TRUE.equals(f.get(IS_STROKE_DASH_FACTOR)) ? strokeWidth : 1d;
    ...
    public static int getFontStyle(Figure f) {
        ...
        if (Boolean.TRUE.equals(f.get(FONT_BOLD))) {
            style |= Font.BOLD;
        }
        if (Boolean.TRUE.equals(f.get(FONT_ITALIC))) {
            style |= Font.ITALIC;
        }
        return style;
    }
